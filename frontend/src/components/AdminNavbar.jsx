...
function AdminNavbarBar() {
  ...
  return (
    <nav className="admin-navbar-bar">
      ...
      <div className="admin-navbar-links">
        <Link to="/Admin" className="admin-navbar-link">Home</Link>
        <Link to="/Admin/users" className="admin-navbar-link">All Users</Link>
      </div>
